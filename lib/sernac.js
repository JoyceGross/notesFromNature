      ...
      $transcribing.on("mousedown", function(e){
        ...
        $transcribing.mousemove(function(e){
          ...
          if (cursorypos > initialypos) { // bottom
            style = { background:"blue", bottom: "auto", top: initialypos, height: (cursorypos - initialypos) };
          } else { // top
            style = { background:"red", top: "auto", height: initialypos - cursorypos , bottom: dh - initialypos};
          }
          s = $.extend(s, style);
